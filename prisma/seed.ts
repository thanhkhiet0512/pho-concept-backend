  ...
  const packages = [
    {
      ...
      descriptionI18n: {
        en: "Perfect for intimate gatherings",
        vi: "Phù hợp cho buổi tụ họp nhỏ",
      },
      minGuests: 10,
      maxGuests: 30,
      basePrice: 45.0,
    ...
    },
    {
      ...
      descriptionI18n: {
        en: "Ideal for corporate events and parties",
        vi: "Lý tưởng cho sự kiện công ty",
      },
      minGuests: 30,
      maxGuests: 60,
      basePrice: 40.0,
    ...
    },
    {
      ...
      descriptionI18n: {
        en: "Full-service for large celebrations",
        vi: "Dịch vụ đầy đủ cho sự kiện lớn",
      },
      minGuests: 60,
      maxGuests: 150,
      basePrice: 35.0,
